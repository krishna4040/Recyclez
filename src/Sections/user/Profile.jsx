...
function Profile() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-green-100 w-full">
  ...
  return (
    <div className="flex flex-col justify-center gap-3 mb-6">
      ...
      <p className="text-sm font-semibold">
        Email: <span className="text-xs text-blue-500">{email}</span>
      </p>
      <p className="text-sm font-semibold">
        Contact: <span className="text-xs text-blue-500"> {contact}</span>
      </p>
    </div>
  );
}
