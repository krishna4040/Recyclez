...
const AddWaste = () => {
    ...
    return (
        <form onSubmit={handleSubmit} className="bg-[#abffa3] w-full h-full p-2">
            <div className="bg-white p-1 ml-[75px] m-1">
                <h1 className="text-3xl font-extrabold text-black font-tiltNeon">Category</h1>
                <div className="flex flex-col items-center m-2 justify-evenly md:flex-row">
                    <Card imgSrc={eWaste} text={"E-waste"} setCategory={setCategory} category={category} />
                    <Card imgSrc={foodWaste} text={"Food Waste"} setCategory={setCategory} category={category} />
                    <Card imgSrc={plasticWaste} text={"Plastic Waste"} setCategory={setCategory} category={category} />
                </div>
            </div>
            <div className="bg-white p-1 ml-[75px] m-1">
                ...
                <div className="flex flex-row items-center m-2 justify-evenly">
                    <select name="measuringunit" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 ">
