  ...
  return (
    <div className="w-full mt-3">
      ...
      <p className="text-sm font-normal mt-1 p-1 text-black">
        ...
        clicking on it, then if receiver will receive it then it will be shown.
      </p>
          ...
          <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
              <tr>
                ...
                <th scope="col" class="px-6 py-3" title="Change it by clicking">
            ...
            <tbody>
              <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                ...
                <td class="px-6 py-4">30 kg</td>
                <td class="px-6 py-4">$1.5/kg</td>
                <td class="px-6 py-4 text-red-500">Pending...</td>
                <td class="px-6 py-4 cursor-pointer hover:text-blue-500">
                  krishna
                </td>
                <td class="px-6 py-4 text-red-500">Pending...</td>
              </tr>
              <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                ...
                <td class="px-6 py-4">200 kg</td>
                <td class="px-6 py-4">$0.33/kg</td>
                <td class="px-6 py-4 text-green-500">Sent</td>
                <td class="px-6 py-4 cursor-pointer hover:text-blue-500">
                  ram
                </td>
                <td class="px-6 py-4 text-red-500">Pending...</td>
